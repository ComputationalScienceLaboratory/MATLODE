...
%
%% Syntax
%    [ Tout, Yout, Lambda, Mu, ISTATUS, RSTATUS, Ierr ] = RK_ADJ1_DiscreteIntegrator( OdeFunction, Tspan, Y, OPTIONS, Coefficient, stack_ptr, adjQuadFlag )
%
%% Input Parameters
...
%
%% Description
% Implicit Runge-Kutta discrete 1 adjoint core method.
%
%% Contact Information
%%
