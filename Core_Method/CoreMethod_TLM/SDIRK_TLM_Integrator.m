...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% Filename: SDIRK_TLM_Integrator.m
%
% Original Author:
%
% File Create Date:
...
%
% SDIRK_TLM_Integrator: INPUT ARGUMENTS
%
% SDIRK_TLM_Integrator: OUTPUT ARGUMENTS
%
% SDIRK_TLM_Integrator: GLOBAL VARIABLES
%
% SDIRK_TLM_Integrator: SYNTAX
%
% SDIRK_TLM_Integrator: EXAMPLE
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
return;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% (END) Core Method: Singly Diagonally Implicit Runge-Kutta Tangent Linear Model Integrator %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
