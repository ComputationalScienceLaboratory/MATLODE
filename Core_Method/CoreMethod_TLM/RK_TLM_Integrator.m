...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% RK_TLM_Integrator:
%   Implicit Runge-Kutta Tangent Linear Model integrator core method.
%       
%       Stages  Order
%       7       5
%
% RK_TLM_Integrator: INPUT ARGUMENTS
%                   NVAR (integer):
%   OdeFunction (function handler):
%             Tspan (double array):
%                 Y (double array):
...
%             Coefficient (struct):
%
% RK_TLM_Integrator: OUTPUT ARGUMENTS
%   Tout (double array):
%   Yout (double array):
%      ISTATUS (struct):
%      RSTATUS (struct):
%        Ierr (integer):
%
% RK_TLM_Integrator: GLOBAL VARIABLES
%
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
