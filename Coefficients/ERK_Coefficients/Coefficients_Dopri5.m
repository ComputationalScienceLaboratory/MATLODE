...
%     rkA(3,7) = 0;
% 
%     rkA(4,1) = 19372.0/6561.0;
%     rkA(4,2) = -25360.0/2187.0;
%     rkA(4,3) = 64448.0/6561.0;
%     rkA(4,4) = -212.0/729.0;
%     rkA(4,5) = 0;
%     rkA(4,6) = 0;
%     rkA(4,7) = 0;
% 
%     rkA(5,1) = 9017.0 / 3168.0;
%     rkA(5,2) = -355.0 / 33.0;
%     rkA(5,3) = 46732.0 / 5247.0;
%     rkA(5,4) = 49.0 / 176.0;
%     rkA(5,5) = -5103.0 / 18656.0;
%     rkA(5,6) = 0;
%     rkA(5,7) = 0;
% 
%     rkA(6,1) = 35.0 / 384.0;
%     rkA(6,2) = 0;
%     rkA(6,3) = 500.0 / 1113.0;
%     rkA(6,4) = 125.0 / 192.0;
%     rkA(6,5) = -2187.0 / 6784.0;
%     rkA(6,6) = 11.0 / 84.0;
%     rkA(6,7) = 0;
