...
% quadrature term.
Option = MATLODE_OPTIONS('Jacobian',Ode_Jacobian,'Lambda',Ode_Lambda,'QFun',Ode_QFun,'DRDY',Ode_DRDY,'Quadrature',Ode_Quadrature);
...
% mu term.
Option = MATLODE_OPTIONS('Jacobian',Ode_Jacobian,'Lambda',Ode_Lambda,'Jacp',Ode_Jacp,'Mu',Ode_Mu);
...
Option = MATLODE_OPTIONS('Jacobian',Ode_Jacobian,'Lambda',Ode_Lambda,'QFun',Ode_QFun,'DRDY',Ode_DRDY,'DRDP',Ode_DRDP,'Quadrature',Ode_Quadrature,'Jacp',Ode_Jacp,'Mu',Ode_Mu);
...
% and relative tolerance values given default option struct.
Option = MATLODE_OPTIONS('Jacobian',Ode_Jacobian,'Lambda',Ode_Lambda,'Max_no_steps',400000,'Hesstr_vec',Ode_Hesstr_vec);
