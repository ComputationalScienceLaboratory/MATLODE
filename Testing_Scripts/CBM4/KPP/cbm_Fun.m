...
% Aggregate function                                               
   ...
   Vdot(7) = -A(69) ;
   Vdot(8) = 0.13*A(52)+0.04*A(53)+0.02*A(56)+0.09*A(59)+0.13*A(76) ...
              +A(78)-A(81);
   ...
   Vdot(16) = -A(36)+A(37)+A(38)+A(39)+A(40)+A(41)+A(45)+0.3*A(56) ...
               +0.33*A(58)+A(60)+0.42*A(62)+2*A(70)+A(71)+0.69*A(72) ...
               +A(74)+0.5*A(75)+0.06*A(77);
   Vdot(17) = -A(60)-A(61)-A(62)+0.45*A(75)+A(76)+0.55*A(77) ;
   Vdot(18) = A(45)+A(46)+2*A(49)+0.79*A(50)+A(51)+0.87*A(52)+0.96 ...
               *A(53)+0.28*A(56)+A(57)+0.22*A(58)+0.91*A(59)+0.7*A(60) ...
               +A(61)+0.08*A(63)+0.6*A(66)+0.5*A(69)+A(70)+0.03*A(72) ...
               +A(73)+0.5*A(75)+A(76)-A(79)-2*A(80);
   Vdot(19) = 0.9*A(64)+0.3*A(66)-A(70)-A(71)-A(72) ;
   Vdot(20) = -1.11*A(52)-2.1*A(53)+0.22*A(56)-A(57)-A(58)-A(59)+1.1 ...
               *A(69)+0.9*A(75)+0.1*A(77);
   Vdot(21) = -A(37)-A(38)-A(39)-A(40)-A(41)+A(45)+A(46)+2*A(49)+0.79 ...
               *A(50)+A(51)+0.2*A(56)+A(57)+0.74*A(58)+A(59)+A(60)+1.56 ...
               *A(61)+A(62)+A(70)+0.7*A(72)+A(76)+A(77);
   Vdot(22) = -A(75)-A(76)-A(77)-A(78) ;
   Vdot(23) = -A(56)-A(57)-A(58)-A(59)+0.55*A(75) ;
   Vdot(24) = -A(42)-A(43)-A(44)-A(45)+0.11*A(52)+1.1*A(53)+0.63*A(56) ...
               +A(57)+0.5*A(58)+A(59)+0.22*A(61)+0.03*A(72)+0.8*A(75) ...
               +0.2*A(76)+0.4*A(77);
   Vdot(25) = A(2)-A(3)-A(7)-A(8)-A(9)-A(12)-A(13)-A(58)-A(62)-A(72) ...
               -A(77);
   Vdot(26) = -A(1)+A(3)-A(4)-A(5)+A(6)-A(7)+0.89*A(14)+2*A(15)-A(17) ...
               +A(19)+2*A(20)-A(21)+A(24)+A(25)-A(26)+A(28)-A(29)+A(30) ...
               +A(31)+A(46)-A(47)+A(48)-A(55)+A(59)+0.9*A(64)-A(68) ...
               +A(79);
   Vdot(27) = 2*A(11)-A(12)+A(13)-A(22)+A(23)-A(24)-A(26)-A(27)+A(28) ...
               -A(31)+2*A(34)-A(35)-A(36)-A(37)+A(40)+A(42)-A(43)+0.79 ...
               *A(50)-A(51)-A(52)+0.2*A(56)-A(57)+0.1*A(58)+0.3*A(60) ...
               -A(61)-A(63)-A(66)-A(69)-A(70)+0.08*A(72)-A(73)-A(76)+0.1 ...
               *A(77);
   Vdot(28) = A(12)-A(13)-A(28)-A(29)+A(30)-2*A(32)-2*A(33)+A(35) ...
               +A(36)+A(37)+2*A(38)+A(40)+A(41)+2*A(45)+A(46)+2*A(49) ...
               -0.21*A(50)+A(51)+0.11*A(52)+0.94*A(53)+A(54)+0.38*A(56) ...
               +A(57)+0.44*A(58)+1.7*A(60)+A(61)+0.12*A(62)+0.44*A(63) ...
               +0.9*A(64)+A(65)+0.6*A(66)+0.7*A(69)+2*A(70)+A(71)+0.76 ...
               *A(72)+A(74)+0.6*A(75)+0.67*A(76)+0.44*A(77);
   Vdot(29) = A(1)-A(2)-A(4)-A(5)-A(6)+A(8)+A(10)+0.89*A(14)-A(40) ...
               -A(42)-A(56)-A(60)-A(75);
   Vdot(30) = A(5)+A(7)-A(14)-A(15)-A(16)-A(17)+A(19)+A(27)-A(41) ...
               -A(44)-A(59)-A(67)-A(78);
   Vdot(31) = A(1)-A(3)+A(4)-A(6)+0.11*A(14)-A(15)+A(16)-2*A(20)-A(21) ...
               -A(22)+A(23)+A(25)-A(28)-A(46)-A(64)-A(79)-A(81);
   Vdot(32) = A(42)+A(43)+A(44)-A(46)-A(47)+A(48)-2*A(49)-A(50)+A(70) ...
               +A(71)+0.62*A(72)+A(73)+A(74)+0.2*A(76);
