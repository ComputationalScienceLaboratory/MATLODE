...
%% Syntax
%                   MATLODE_PEXP_FWD_Integrator
%          [T, Y] = MATLODE_PEXP_FWD_Integrator(Ode_Function, Time_Interval, Y0)
%   [T, Y, Stats] = MATLODE_PEXP_FWD_Integrator(Ode_Function, Time_Interval, Y0)
%
%% Input Parameters
...
%
%% Description
% Driver file to solve the system y' = F(t,y) using a Partitioned Exponential (PEXP)
% method.
%
% |MATLODE_PEXP_FWD_Integrator| displays the available methods
% associated with the partitioned exponential forward integrator.
%
% |[T, Y] = MATLODE_PEXP_FWD_Integrator(Ode_Function, Time_Interval, Y0, Options)|
...
% to illustrate |MATLODE_PEXP_FWD_Integrator| functionalities and features.
...
% settings. We note that a Jacobian is required for an exponential method.
%
...
% Forward Integration -> MATLODE_Example_PEXP_FWD_Integrator.
%
%% Contact Information
%%
...
%
function  [ Tout_FWD, Yout_FWD, Stats_FWD ] = MATLODE_PEXP_FWD_Integrator( OdeFunction1, OdeFunction2, Tspan, Y0, OPTIONS_U )
    % Display input/output parameters
    if ( nargout == 0 && nargin == 0 )
        fprintf('Syntax: \n');
        fprintf( '                     MATLODE_PEXP_FWD_Integrator \n' );
        fprintf( '          [ T, Y ] = MATLODE_PEXP_FWD_Integrator(Ode_Function, Time_Interval, Y0, Options) \n' );
        fprintf( '   [ T, Y, Stats ] = MATLODE_PEXP_FWD_Integrator(Ode_Function, Time_Interval, Y0, options) \n' );
        fprintf( '\n' );
        return;
    end
    ...
    % Configure Options
    [ OPTIONS, Coefficient ] = OPTIONS_Configuration(OPTIONS_U,'PEXP','FWD',Y0, Tspan);
    ...
    for interval=1:tspanMaxSize-1
        ...
        [ Tout_FWD_interval, Yout_FWD_interval, ISTATUS_FWD_interval, RSTATUS_FWD, Ierr ] = ...
            PEXP_FWD_Integrator( OdeFunction1, OdeFunction2, ...
            [Tspan(interval), Tspan(interval+1)],...
            Yout_FWD_interval(end,:), OPTIONS, Coefficient );
...
%   <tr>
%       <td>1/1/2014</td>
%       <td>Mahesh Narayanamurthi</td>
%       <td>maheshnm@vt.edu</td>
%       <td>Implemented PEXP and all supporting components</td>
%   </tr>
%   <tr>
%       <td>1/1/2014</td>
