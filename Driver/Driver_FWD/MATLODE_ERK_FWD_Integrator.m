...
function [ Tout_FWD, Yout_FWD, FWD_Stats ] = MATLODE_ERK_FWD_Integrator( OdeFunction, Tspan, Y0, varargin )
    ...
    if ( nargout == 0 && nargin == 0 )
        fprintf('Syntax: \n');
        fprintf( '                     MATLODE_ERK_FWD_Integrator \n' );
        fprintf( '          [ T, Y ] = MATLODE_ERK_FWD_Integrator(odefun, Tspan, y0) \n' );
        fprintf( '   [ T, Y, Stats ] = MATLODE_ERK_FWD_Integrator(odefun, Tspan, y0) \n' );
        fprintf( '          [ T, Y ] = MATLODE_ERK_FWD_Integrator(odefun, Tspan, y0, options) \n' );
        fprintf( '   [ T, Y, Stats ] = MATLODE_ERK_FWD_Integrator(odefun, Tspan, y0, options) \n' );
        fprintf( '\n' );
        return;
    end
