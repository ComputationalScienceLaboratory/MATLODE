...
% Mathematica file: expK_framework_embedded_method_nosubsuperscripts_withdefaults_modified_formulation_stiffoc.nb
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    A21 = [[0, 0, 0]; [3/5, 0, 0]; [-3/16, 15/16, 0]; ...
        [162817736887163/1152617431436856, 7137645057174722346/71376450571747223461, -359749112930725/1820132219796202]];
    
    A22 = [[0, 0, 0, 0]; [3/5, 0, 0, 0]; [-3/16, 15/16, 0, 0]; [80033718243295/328533311565827, -1123983780143874849/11239837801438748489, ...
    -1425099340545942011/14250993405459420109, 0]];
    ...
    G22 = [[1/2, 0, 0, 0]; [-13/40, 1/4, 0, 0]; [41/128, -35/128, 1/8, 0]; ...
        [-1088190160807945591/10881901608079455909, 1162468029258153/4518294103221470, -1142265459372840750/11422654593728407499, 206115739029203/1321737467898953]];
    ...
    BH2 =  [257056210248115/1681527663978187, 252488275744237/585295170266930, 137781471210338/436372029187411, 3152545810228169611/31525458102281696111];
    BH  = {BH1,BH2};
