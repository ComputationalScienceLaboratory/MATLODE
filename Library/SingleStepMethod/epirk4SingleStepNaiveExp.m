...
%
function [y, yerr, ISTATUS] = epirk4SingleStepNaiveExp(y0, dt, rhsFun, jacFun, ...
    ...
    for i = 1 : s - 1
        ...
        if a(i, 1) ~= 0
            [psi, krySteps] = Psi(i, 1, jacFun, f, N, ...
                                  dt, g, p, MatrixFree, NBasisVectors, krySteps);
            psiCount = psiCount + 1;
        ...
        for j = 2: i
            if a(i, j) ~= 0
                ...
                [psi, krySteps] = Psi(i, j, jacFun, dr, N, dt,  g, p, ...
                                      MatrixFree, NBasisVectors, krySteps);
                psiCount = psiCount + 1;
...
function [psi, krySteps] = Psi(i, j, A0, v, N, dt, g, p, MatrixFree, NBasisVectors, krySteps)
