      ...
      case 'EXP'
        switch( OPTIONS.Method )
          ...
          case 17
            ...
            expELO = 4;
          case 18
            OPTIONS.OneStepIntegrator = @epirk3WcDSingleStepNaiveExp;
            expName = 'EPIRKK3WcD';
            expMethod = 18;
            expELO = 3;
          otherwise
      ...
      case 'PEXP'
        switch( OPTIONS.Method )
          ...
          case 5
            ...
            expELO = 3;
          case 6
            OPTIONS.OneStepIntegrator = @psexp3ASingleStep;
            expName = 'psexp3a';
            expMethod = 6;
            expELO = 3;
          case 7
            OPTIONS.OneStepIntegrator = @psepirk3bSingleStepRD;
            expName = 'psepirk3b';
            expMethod = 7;
            expELO = 3;
          case 8
            OPTIONS.OneStepIntegrator = @pexp3WASingleStepRD;
            expName = 'pexp3WA';
            expMethod = 8;
            expELO = 3;
          otherwise
