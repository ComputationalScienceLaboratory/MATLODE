...
% </html>
%
%% Multirate General Additive Runge-Kutta (MRGARK) Forward (FWD) Fine Tuning
% The following is the default fine tuning for the MRGARK FWD integrator.
...
% desired.  
%
function [ OPTIONS ] = OPTIONS_FineTuned_EXIM_MRGARK_FWD
