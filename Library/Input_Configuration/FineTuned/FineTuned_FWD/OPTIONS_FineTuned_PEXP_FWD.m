...
% </html>
%
%% Partitioned Exponential (PEXP) Forward (FWD) Fine Tuning
% The following is the default fine tuning for the PEXP FWD integrator.
...
% desired. 
%
function [ OPTIONS ] = OPTIONS_FineTuned_PEXP_FWD
