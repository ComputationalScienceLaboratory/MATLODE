...
% </html>
%
%% Implicit Runge-Kutta (RK) Adjoint (ADJ) Fine Tuning
% The following is the default fine tuning for the RK ADJ integrator.
...
% desired.  
%
function OPTIONS = OPTIONS_FineTuned_RK_ADJ
