...
% </html>
%
%% Singly Diagonally Implicit Runge-Kutta (SDIRK) Adjoint (ADJ) Fine Tuning
% The following is the default fine tuning for the SDIRK ADJ integrator.
...
% desired.  
%
function OPTIONS = OPTIONS_FineTuned_SDIRK_ADJ
% something
