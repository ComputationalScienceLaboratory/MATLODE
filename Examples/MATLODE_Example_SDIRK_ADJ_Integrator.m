%% MATLODE_Example_SDIRK_ADJ_Integrator
%
% <html>
...
% singly diagonally implicit Runge-Kutta integration using MATLODE's prebuilt default
...
Options = MATLODE_OPTIONS('Jacobian',Ode_Jacobian,'Lambda',Ode_Lambda,'Jacp',Ode_Jacp,'Mu',Ode_Mu,'NP',1);
...
Options = MATLODE_OPTIONS('Jacobian',Ode_Jacobian,'Lambda',Ode_Lambda,'Jacp',Ode_Jacp,'Mu',Ode_Mu,'Quadrature',Ode_Quadrature,'QFun',Ode_QFun,'DRDY',Ode_DRDY,'DRDP',Ode_DRDP,'NP',1);
